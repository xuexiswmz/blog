  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={cardRef}
          className="relative isolate h-full w-full overflow-hidden rounded-md border border-slate-200/90 bg-white/75 px-5 py-4 backdrop-blur-xl transition-transform ease-out will-change-transform transform-3d dark:border-white/10 dark:bg-[#0d1117]/85"
        >
