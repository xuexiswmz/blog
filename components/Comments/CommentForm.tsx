...
function CommentForm({
    ...
    const canSubmit = usernameLength >= 2 && usernameLength <= 20 && contentLength >= 1 && contentLength <= 1000 && !submitting
    ...
    async function handleSubmit(event:SubmitEvent<HTMLFormElement>) {
        ...
        try {
            ...
            setError(
                error instanceof Error ? error.message : "提交评论失败"
            )
        } finally {
            setSubmitting(false)
        }
        ...
        >
            ...
            <div className="space-y-1">
                ...
                <textarea
                    ...
                    placeholder={
                        replyTarget ? `回复 @${replyTarget.username}` : "写下你对这个段落的看法"
                    }
